...
make -j 16 -C /lib/modules/`uname -r`/build M=/root/nft/net/netfilter modules
make -j 16 -C /lib/modules/`uname -r`/build KBUILD_EXTRA_SYMBOLS=/root/nft/net/netfilter/Module.symvers M=/root/nft/net/ipv4/netfilter modules
